...
data = pd.read_csv('C://Users//USER//OneDrive//Masaüstü//movies_data.csv', delimiter=';')  # CSV dosyasının yolu

# Verileri Firestore'a yükle
for index, row in data.iterrows():
    doc_ref = db.collection('movies').document()  # 'movies' koleksiyon adınız
